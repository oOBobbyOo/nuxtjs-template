...
function onProgress(swiper: SwiperClass) {
...
function setTransition(swiper: SwiperClass, transition: number) {
  for (let i = 0; i < swiper.slides.length; i += 1) {
...
<template>
  <Swiper
    ...
    loop navigation autoplay centered-slides watch-slides-progress
